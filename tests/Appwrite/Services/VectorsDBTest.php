...
final class VectorsDBTest extends TestCase
{
    ...
    public function testMethodListSpecifications(): void
    {
        ...
        $response = $this->vectorsDB->listSpecifications();
    ...
    public function testMethodListCollections(): void
    {
        ...
        $this->assertInstanceOf(\Appwrite\Models\VectorsdbCollectionList::class, $response);
    }
    ...
    public function testMethodCreateQuery(): void
    {
        $data = [
            "total" => 5,
            "documents" => [
    ...
    public function testMethodListOperations(): void
    {
        ...
        $response = $this->vectorsDB->listOperations(
            "<DATABASE_ID>"
        );
    ...
    public function testMethodGetReplicas(): void
    {
        ...
        $response = $this->vectorsDB->getReplicas(
            "<DATABASE_ID>"
        );
