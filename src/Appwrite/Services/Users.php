...
use Appwrite\Enums\PasswordVersion;
...
class Users extends Service
{
     ...
     */
    public function createSHAUser(string $userId, string $email, string $password, PasswordVersion $passwordVersion = null, string $name = null): array
    {
     ...
     */
    public function deleteAuthenticator(string $userId, AuthenticatorProvider $provider, string $otp): array
    {
        $apiPath = str_replace(['{userId}', '{provider}'], [$userId, $provider], '/users/{userId}/mfa/{provider}');
     ...
     */
    public function listProviders(string $userId): array
    {
        $apiPath = str_replace(['{userId}'], [$userId], '/users/{userId}/providers');
