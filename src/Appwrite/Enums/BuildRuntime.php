...
class BuildRuntime implements JsonSerializable, Stringable
{
    ...
    private static BuildRuntime $BUN14;
    ...
    private static BuildRuntime $RUST183;
    ...
    public static function DART311(): BuildRuntime
    {
    ...
    public static function BUN14(): BuildRuntime
    {
        if (!isset(self::$BUN14)) {
            self::$BUN14 = new BuildRuntime('bun-1.4');
        }
        return self::$BUN14;
    }
    ...
    public static function RUST183(): BuildRuntime
    {
        if (!isset(self::$RUST183)) {
            self::$RUST183 = new BuildRuntime('rust-1.83');
        }
        return self::$RUST183;
    }
    ...
    public static function FLUTTER341(): BuildRuntime
    {
        if (!isset(self::$FLUTTER341)) {
            self::$FLUTTER341 = new BuildRuntime('flutter-3.41');
        }
