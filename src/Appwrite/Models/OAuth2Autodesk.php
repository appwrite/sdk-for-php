 ...
 * OAuth2Autodesk
 */
readonly class OAuth2Autodesk
{
    use ArraySerializable;

    /**
     * OAuth2Autodesk constructor.
     *
     * @param string $id oauth2 provider id.
     * @param bool $enabled oauth2 provider is active and can be used to create sessions.
     * @param string $clientId autodesk oauth2 client id.
     * @param string $clientSecret autodesk oauth2 client secret.
     */
