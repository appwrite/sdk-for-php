 ...
 * AttributeBoolean
 */
readonly class AttributeBoolean
{
     ...
     * @param bool|null $xdefault default value for attribute when not provided. cannot be set when attribute is required.
     */
