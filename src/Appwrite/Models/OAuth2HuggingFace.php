 ...
 */
readonly class OAuth2HuggingFace
{
    use ArraySerializable;

    /**
     * OAuth2HuggingFace constructor.
     *
     * @param string $id oauth2 provider id.
     * @param bool $enabled oauth2 provider is active and can be used to create sessions.
     * @param string $clientId hugging face oauth2 client id.
     * @param string $clientSecret hugging face oauth2 client secret.
     */
