...
readonly class ColumnBoolean
{
     ...
     * @param bool|null $xdefault default value for column when not provided. cannot be set when column is required.
     */
