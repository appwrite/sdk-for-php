 ...
 * ColumnBigInt
 */
readonly class ColumnBigint
{
    use ArraySerializable;

    /**
     * ColumnBigint constructor.
     *
     ...
     * @param int|null $default default value for column when not provided. cannot be set when column is required.
     */
