...
readonly class OAuth2Auth0
{
     ...
     * @param string $clientId auth0 oauth2 client id.
     * @param string $clientSecret auth0 oauth2 client secret.
     * @param string $endpoint auth0 oauth2 endpoint domain.
     */
