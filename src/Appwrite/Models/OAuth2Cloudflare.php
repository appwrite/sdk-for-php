 ...
 */
readonly class OAuth2Cloudflare
{
    use ArraySerializable;

    /**
     * OAuth2Cloudflare constructor.
     *
     * @param string $id oauth2 provider id.
     * @param bool $enabled oauth2 provider is active and can be used to create sessions.
     * @param string $clientId cloudflare oauth2 client id.
     * @param string $clientSecret cloudflare oauth2 client secret.
     */
