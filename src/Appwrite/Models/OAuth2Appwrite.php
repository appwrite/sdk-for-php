 ...
 */
readonly class OAuth2Appwrite
{
    use ArraySerializable;

    /**
     * OAuth2Appwrite constructor.
     *
     * @param string $id oauth2 provider id.
     * @param bool $enabled oauth2 provider is active and can be used to create sessions.
     * @param string $clientId appwrite oauth2 client id.
     * @param string $clientSecret appwrite oauth2 client secret.
     */
