 ...
 * ColumnPolygon
 */
readonly class ColumnPolygon
{
    use ArraySerializable;

    /**
     * ColumnPolygon constructor.
     *
     ...
     * @param array|null $default default value for column when not provided. cannot be set when column is required.
     */
