 ...
 * OAuth2Authentik
 */
readonly class OAuth2Authentik
{
     ...
     * @param string $clientId authentik oauth2 client id.
     * @param string $clientSecret authentik oauth2 client secret.
     * @param string $endpoint authentik oauth2 endpoint domain.
     */
