 ...
 * AttributeBigInt
 */
readonly class AttributeBigint
{
    use ArraySerializable;

    /**
     * AttributeBigint constructor.
     *
     ...
     * @param int|null $default default value for attribute when not provided. cannot be set when attribute is required.
     */
