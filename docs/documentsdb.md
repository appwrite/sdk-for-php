...
```http request
GET https://cloud.appwrite.io/v1/documentsdb/specifications
```
...
```http request
POST https://cloud.appwrite.io/v1/documentsdb/{databaseId}/failovers
```
...
```http request
GET https://cloud.appwrite.io/v1/documentsdb/{databaseId}/operations
```
...
```http request
GET https://cloud.appwrite.io/v1/documentsdb/{databaseId}/replicas
```
...
```http request
GET https://cloud.appwrite.io/v1/documentsdb/{databaseId}/status
```
