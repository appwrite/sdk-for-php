...
```http request
GET https://HOSTNAME/v1/storage/files
```
...
```http request
POST https://HOSTNAME/v1/storage/files
```
...
```http request
GET https://HOSTNAME/v1/storage/files/{fileId}
```
...
```http request
PUT https://HOSTNAME/v1/storage/files/{fileId}
```
...
```http request
DELETE https://HOSTNAME/v1/storage/files/{fileId}
```
...
```http request
GET https://HOSTNAME/v1/storage/files/{fileId}/download
```
...
```http request
GET https://HOSTNAME/v1/storage/files/{fileId}/preview
```
...
```http request
GET https://HOSTNAME/v1/storage/files/{fileId}/view
```
