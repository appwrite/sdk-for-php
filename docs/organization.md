...
```http request
GET https://cloud.appwrite.io/v1/organization/installations
```
...
```http request
POST https://cloud.appwrite.io/v1/organization/installations
```
...
```http request
GET https://cloud.appwrite.io/v1/organization/installations/{installationId}
```
...
```http request
DELETE https://cloud.appwrite.io/v1/organization/installations/{installationId}
```
