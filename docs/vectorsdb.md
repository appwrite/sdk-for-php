...
```http request
GET https://cloud.appwrite.io/v1/vectorsdb/specifications
```
...
| queries | array | Array of query strings generated using the Query class provided by the SDK. [Learn more about queries](https://appwrite.io/docs/queries). Maximum of 100 queries are allowed, each 524288 characters long. | [] |
...
```http request
POST https://cloud.appwrite.io/v1/vectorsdb/{databaseId}/collections/{collectionId}/documents/query
```
...
```http request
POST https://cloud.appwrite.io/v1/vectorsdb/{databaseId}/failovers
```
...
```http request
GET https://cloud.appwrite.io/v1/vectorsdb/{databaseId}/operations
```
...
```http request
GET https://cloud.appwrite.io/v1/vectorsdb/{databaseId}/replicas
```
...
```http request
GET https://cloud.appwrite.io/v1/vectorsdb/{databaseId}/status
```
