...
```http request
GET https://cloud.appwrite.io/v1/databases/{databaseId}/tables
```
...
```http request
POST https://cloud.appwrite.io/v1/databases/{databaseId}/tables
```
...
```http request
GET https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}
```
...
```http request
PUT https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}
```
...
```http request
DELETE https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}
```
...
```http request
GET https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns
```
...
```http request
POST https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/boolean
```
...
| --- | --- | --- | --- |
| databaseId | string | **Required** Database ID. |  |
| tableId | string | **Required** Table ID. You can create a new table using the Database service [server integration](https://appwrite.io/docs/server/tables#tablesCreate). |  |
...
```http request
PATCH https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/boolean/{key}
```
...
```http request
POST https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/datetime
```
...
```http request
PATCH https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/datetime/{key}
```
...
```http request
POST https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/email
```
...
```http request
PATCH https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/email/{key}
```
...
```http request
POST https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/enum
```
...
```http request
PATCH https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/enum/{key}
```
...
```http request
POST https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/float
```
...
```http request
PATCH https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/float/{key}
```
...
```http request
POST https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/integer
```
...
```http request
PATCH https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/integer/{key}
```
...
```http request
POST https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/ip
```
...
```http request
PATCH https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/ip/{key}
```
...
```http request
POST https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/relationship
```
...
```http request
POST https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/string
```
...
```http request
PATCH https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/string/{key}
```
...
```http request
POST https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/url
```
...
```http request
PATCH https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/url/{key}
```
...
```http request
GET https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/{key}
```
...
```http request
DELETE https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/{key}
```
...
```http request
PATCH https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/columns/{key}/relationship
```
...
```http request
GET https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/indexes
```
...
```http request
POST https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/indexes
```
...
```http request
GET https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/indexes/{key}
```
...
```http request
DELETE https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/indexes/{key}
```
...
```http request
GET https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/rows
```
...
```http request
POST https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/rows
```
...
| --- | --- | --- | --- |
| databaseId | string | **Required** Database ID. |  |
| tableId | string | **Required** Table ID. You can create a new table using the Database service [server integration](https://appwrite.io/docs/server/tables#tablesCreate). Make sure to define columns before creating rows. |  |
...
```http request
PUT https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/rows
```
...
```http request
PATCH https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/rows
```
...
```http request
DELETE https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/rows
```
...
```http request
GET https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/rows/{rowId}
```
...
```http request
PUT https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/rows/{rowId}
```
...
```http request
PATCH https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/rows/{rowId}
```
...
```http request
DELETE https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/rows/{rowId}
```
...
```http request
PATCH https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/rows/{rowId}/{column}/decrement
```
...
```http request
PATCH https://cloud.appwrite.io/v1/databases/{databaseId}/tables/{tableId}/rows/{rowId}/{column}/increment
```
